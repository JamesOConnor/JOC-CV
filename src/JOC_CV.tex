...
\location{Twitter account which posts a Sentinel-2 satellite image every hour |} \href{http://twitter.com/sentinel\_bot}{twitter.com/sentinel\_bot}
...
\location{Simple web app for making satellite gifs |}\href{https://github.com/JamesOConnor/sat\_giffer}{github.com/JamesOConnor/sat\_giffer}
\sectionsep
